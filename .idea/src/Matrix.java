...
public class Matrix<twoDimArray, myArray, i> {
    ...
    public static double[] @NotNull [] matrix_add(double[][] ar1, double[][] ar2) {
    ...
    public static void print2DArray(double[] @NotNull [] ar)
    {
